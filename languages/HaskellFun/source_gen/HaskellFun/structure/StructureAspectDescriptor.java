...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptDeclaration, myConceptDefinitionParameter, myConceptDefinitionReference, myConceptDoExpression, myConceptEmptyLine, myConceptForm, myConceptHaskellExpression, myConceptHaskellModule, myConceptImport, myConceptPrintln);
  }
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0o = new String[]{"HaskellFun.structure.Declaration", "HaskellFun.structure.DefinitionParameter", "HaskellFun.structure.DefinitionReference", "HaskellFun.structure.DoExpression", "HaskellFun.structure.EmptyLine", "HaskellFun.structure.Form", "HaskellFun.structure.HaskellExpression", "HaskellFun.structure.HaskellModule", "HaskellFun.structure.Import", "HaskellFun.structure.Println"};
}
